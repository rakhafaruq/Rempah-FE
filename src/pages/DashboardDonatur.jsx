        ...
        <div className="p-8">
            ...
            {loading ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    {[1, 2, 3, 4].map((n) => (
                        <div key={n} className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm animate-pulse">
                            <div className="w-12 h-12 bg-stone-200 rounded-2xl mb-4"></div>
                            <div className="h-4 bg-stone-200 rounded-full w-2/3 mb-2"></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        {stats.map((s) => (
                            <div key={s.label} className="bg-white rounded-3xl p-6 shadow-md shadow-gray-100 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                                <div
                                    className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-4 ${s.color === "orange" ? "bg-orange-100 text-orange-600" : s.color === "green" ? "bg-green-100 text-green-600" : "bg-teal-100 text-teal-600"}`}
                                >
